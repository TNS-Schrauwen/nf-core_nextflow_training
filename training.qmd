  ...
  revealjs:
    ...
    include-in-header:
      text: |
        ...
        <style>
          .reveal, .reveal-viewport { background-color: #ffffff !important; }
          .reveal h1 { color: #009B77 !important; font-family: 'Maven Pro', sans-serif !important; font-size: 2.7em !important; }
          .reveal h2 { color: #00A881 !important; font-family: 'Maven Pro', sans-serif !important; font-size: 2.1em !important; }
          .reveal h3 { color: #008264 !important; font-family: 'Maven Pro', sans-serif !important; font-size: 1.9em !important; }
          .reveal p, .reveal li { color: #212529 !important; font-family: 'Inter', sans-serif !important; }
          .reveal strong { color: #009B77 !important; }
          .reveal [data-background-color="#212529"] p,
          .reveal [data-background-color="#212529"] li { color: #f8f9fa !important; }
          .reveal [data-background-color="#212529"] strong { color: #00A881 !important; }
          .reveal a { color: #009B77 !important; }
          .reveal .footer { color: #adb5bd !important; }
          .reveal .slide-number { color: #adb5bd !important; }
          .reveal table td, .reveal table th { color: #212529 !important; }
          .reveal .callout { background-color: #FFFAED !important; border-color: #008264 !important; }
          .reveal .callout-title { background-color: #FFF3C4 !important; color: #212529 !important; }
          .reveal .callout-body p { color: #212529 !important; }
        </style>
execute:
  echo: false
  eval: true
...
``` bash
# Bash work great .. until it doesn't 
...
![](images/nf_img_01.png){width="70%" fig-align="center"}
...
-   📦 **90+ curated pipelines**
-   🧱 **1200+ reusable modules**
-   🛠️ Dedicated **CLI tools** to create, test, and maintain pipelines
-   📋 **Shared standards** for quality and reproducibility
:::
::::
...
{{< video https://www.youtube.com/watch?v=ktn2SwKfRPs width="100%" height="500px" >}}

::: fragment
👉 [nf-core Hackathon 2026](https://nf-co.re/events/2026/hackathon-march-2026)
...
------------------------------------------------------------------------
## 🎉 You went from "What is Nextflow?" to opening a real PR! {.center}
::: fragment
